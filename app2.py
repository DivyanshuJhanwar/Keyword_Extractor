    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            if filename:
                ...
                return render_template('index2.html', extracted_text=extracted_text, extracted_keywords=extracted_keywords)

    # Show the home page for both GET and POST requests
    return render_template('index2.html', extracted_text=None)
